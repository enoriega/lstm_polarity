...
ModelElements = namedtuple("ModelElements", "W V b w2v_emb c2v_emb missing_emb param_collection builder")
...
#                    input('press enter to continue')
                    input_word_char = dy.concatenate([embeddings[w], average_char_embd])
...
def build_model(missing_voc, w2v_embeddings, char_embeddings, attention_sel):
    ...
    if attention_sel==0:
        ...
        ret = ModelElements(W, V, b, w2v_wemb, c2v_emb, missing_wemb, params, builder)
