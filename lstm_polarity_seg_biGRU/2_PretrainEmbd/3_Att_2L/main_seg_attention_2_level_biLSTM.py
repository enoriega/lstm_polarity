...
def main(input_path):
    ...
    for e in range(epochs):
        ...
        for i, instance in enumerate(training):
            ...
            prediction = run_instance(instance, builder, ix, W, V, b, HIDDEN_DIM, W_a, b_a, W_a_2, b_a_2)
...
def run_instance(instance, builder, ix, W, V, b, HIDDEN_DIM, W_a, b_a, W_a_2, b_a_2):
