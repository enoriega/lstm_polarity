...
#        print('event end:', d['event interval end'])
    ...
    elements = build_model(missing_voc, embeddings, char_embeddings, attention_sel)
    ...
    embeddings_char_index = CharEmbeddingIndex(elements.c2v_emb, char_embeddings)
...
#    print(params.lookup_parameters_list())
    ...
    for e in range(epochs):
        ...
        for i, instance in enumerate(training):
            ...
            prediction = run_instance(instance, elements, embeddings_index, embeddings_char_index, attention_sel)
