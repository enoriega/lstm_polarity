...
#        print('event end:', d['event interval end'])
    ...
    #training = instances[:52421]
    #testing = instances[52421:]
    
    random.Random(python_rand_seed).shuffle(training)
    random.Random(python_rand_seed).shuffle(testing)
    ...
    for e in range(epochs):
        ...
        for i, instance in enumerate(training):
            ...
            prediction = run_instance(instance, elements, embeddings_index, attention_sel, True)
        ...
        for i, instance in enumerate(testing):
            prediction = run_instance(instance, elements, embeddings_index, attention_sel, False)
